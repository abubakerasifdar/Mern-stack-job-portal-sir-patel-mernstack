    ...
    <>
      ...
      <div className="flex py-4 justify-between items-center">
          <div className="text-3xl font-extrabold">
            Companies by <span className="text-[#26A4FF]">Category</span>{" "}
          </div>
        ...
        <div className="flex justify-between overflow-scroll overflow-y-hidden gap-4 py-4">
          {/* svg 1  */}
          <div className="p-5 basis-auto bg-[#4640DE] flex flex-col  gap-3 ">
            ...
            <span className="font-bold text-white text-lg ">Design</span>
          </div>
          {/* svg 2  */}
          <div className="p-5 basis-auto border border-slate-400 flex flex-col  gap-3 ">
            <svg
              width="48"
              height="48"
              viewBox="0 0 24 24"
